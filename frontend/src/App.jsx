...
// function App() {
//   const [activeTab, setActiveTab] = useState('professors') // professors, students, sessions, reports
...
//       })
//       if (!response.ok) throw new Error("Création du professeur impossible")
...
//     const ok = window.confirm('Confirmer la suppression du professeur #' + id + ' ?')
//     if (!ok) return
//     try {
...
//     const ok = window.confirm('Confirmer la suppression de l\\étudiant #' + id + ' ?')
//     if (!ok) return
//     try {
...
//   // Ensure page within bounds when data or filters change
...
//                   placeholder="Rechercher professeur (prénom, nom, matière)..."
//                   value={profSearch}
...
//                     <div className="pager" aria-hidden={profTotalPages<=1}>
//                       <button onClick={() => setProfPage(p => Math.max(1, p-1))} disabled={profPage<=1}>Prev</button>
//                       <div>Page {profPage} / {profTotalPages}</div>
//                       <button onClick={() => setProfPage(p => Math.min(profTotalPages, p+1))} disabled={profPage>=profTotalPages}>Next</button>
//                     </div>
//                   </>
//                 )}
//               </div>
...
//                 <input
//                   className="search-input"
//                   placeholder="Rechercher étudiant (prénom, nom)..."
//                   value={studSearch}
...
//                     <div className="pager" aria-hidden={studTotalPages<=1}>
//                       <button onClick={() => setStudPage(p => Math.max(1, p-1))} disabled={studPage<=1}>Prev</button>
//                       <div>Page {studPage} / {studTotalPages}</div>
//                       <button onClick={() => setStudPage(p => Math.min(studTotalPages, p+1))} disabled={studPage>=studTotalPages}>Next</button>
//                     </div>
//                   </>
//                 )}
//               </div>
